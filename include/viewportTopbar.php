...
<style>
            ...
            /* Media query for even smaller screens (below 480px) */
        ...
        <nav class="d-flex justify-content-between px-3 align-middle navbar-expand viewport-topbar  topbar static-top pt-2" >

            <div>
                <img class="sidebar-brand-text" src="https://www.csaengineering.com.au/wp-content/uploads/2022/10/White-Logo.png" alt="logo" style="max-width: 100px; height: auto;">
            </div>


            <?php 
            $current_page =  $current_page = basename($_SERVER['REQUEST_URI']);
             if ($current_page === "viewPort.php") { ?>
            <!-- <div  style="margin-left: 70rem; margin-top:;"> <a class="btn btn-secondary" style="text-decoration:none; font-size:1.1rem; padding: 0.4rem 1.2rem ;" href="../welcome.php">Employee Dashboard</a></div> -->
          ...
          <?php } ?>
            ...
            <ul class="" >
                ...
                <ul class="">
                    ...
                    <div class="theme-switch d-flex align-items-center ">
                    <div class="d-flex align-items-center mr-5">
                    <button id="clearSearch" class="btn btn-danger" type="button" style="display: none;">Clear Filter</button>
                        </div>
