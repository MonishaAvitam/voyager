...
<nav class="navbar navbar-expand topbar static-top shadow">
    ...
    <!-- Logo -->
    <div class="ms-5">
        <img class="sidebar-brand-text mx-3" src="./img/logo.png" alt="logo" style="height: 3.5rem;">
    </div>

    <?php
    $current_page = basename($_SERVER['REQUEST_URI']);
    if ($current_page === "viewPort.php") {
        // Add custom viewport page logic if needed
    }
    ?>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                const themeBtn = document.getElementById('themeState');
                const storedTheme = sessionStorage.getItem('theme') || 'light-mode';

                document.body.classList.add(storedTheme);
                themeBtn.checked = storedTheme === 'dark-mode';
        ...
        <li class="nav-item dropdown no-arrow me-5">
            <a class="nav-link dropdown-toggle" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline small username-text">
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="profile.php">
                    <i class="fas fa-user fa-sm fa-fw mr-2 text-green"></i> Profile
                </a>
                <a class="dropdown-item" href="#">
                    <i class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i> Settings
                </a>
                <a class="dropdown-item" href="time-sheet.php">
                    <i class="fas fa-list fa-sm fa-fw mr-2 text-green"></i> Time sheet
                </a>
