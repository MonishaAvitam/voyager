...
if (isset($_GET['table_id'])) {
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['send_data_verifier'])) {
    ...
    if (isset($_POST['assign_to_verifier'])) {
      ...
      $sql = "UPDATE subprojects SET verify_by = ?, verify_by_name = ?, verify_status = ?, assign_status = ?, checker_status = ?,project_manager_status = ?,assign_to_status = ?  WHERE table_id = ?";
      ...
      $params = ["ssiiiiii", $user_id, $fullname, $status_value, $assign_status, $checker_status,$project_manager_status,$assign_to_status, $table_id];
