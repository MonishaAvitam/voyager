...
<style>
        ...
        <nav class="d-flex justify-content-between px-3 align-middle navbar-expand viewport-topbar topbar static-top pt-2" style="position:fixed; top:0; left: 0; right: 0; width: 100vw; z-index: 999; " >

           <a href="./sales_dashboard.php">
           <div>
                <img class="sidebar-brand-text mt-1" src="https://www.csaengineering.com.au/wp-content/uploads/2022/10/White-Logo.png" alt="logo" style="max-width: 100px; height: auto;">
            </div>
           </a>
