...
<div id="wrapper">
  ...
  <ul class="navbar-nav  sidebar sidebar-dark accordion" style="background-color: #070A19;" id="accordionSidebar">
    ...
    <li class="nav-item">
      <a class="nav-link" href="./all-projects.php">
        <i class="fas fa-fw fa-folder-open" style="color: orange;"></i>
    ...
    <li class="nav-item">
      ...
      <a class="nav-link" href="potential_customer.php">

        <i class="fas fa-arrow-alt-circle-right" style="color: #90EE90;"></i>
    ...
    <li class="nav-item">
      ...
      <a class="nav-link" href="converted_to_projects.php">
    ...
    <li class="nav-item">
      ...
      <a class="nav-link" href="rejected_enquiries.php">

        <i class="far fa-regular fa-times-circle" style="color: #FFFF00;"></i> <span>Rejected Enquiries</span>
    ...
    <li class=" nav-item">
          ...
          <a class="nav-link" href="customer_database.php">

            <i class="fas fa-arrow-alt-circle-right" style="color: #FFFF00;"></i>
  ...
  <div id="content-wrapper" class="d-flex flex-column">
    ...
    <nav class=" navbar-expand navbar-light  topbar mb-4 static-top shadow" style="">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <?php
          $sql = "SELECT msg_subject,msg_content, created_at, id, msg_status,
               SUM(CASE WHEN msg_status = 'unread' AND msg_to = $user_id THEN 1 ELSE 0 END) AS unread_msg
        FROM notifications
        WHERE msg_to = $user_id
        GROUP BY msg_subject,msg_content, created_at, id, msg_status
        ORDER BY id DESC
        ";
          ...
          if ($stmt->num_rows > 0) {
            ...
            while ($row = $stmt->fetch_assoc()) {
              ...
              <script>
                  ...
                  anchor.setAttribute("data-target", "#showMessageBox");
                  anchor.setAttribute("data-id", "' . addslashes($row['id']) . '" );
                  anchor.setAttribute("data-subject", "' . addslashes($row['msg_subject']) . '" );
                  anchor.setAttribute("data-content", "' . addslashes($row['msg_content']) . '" );

                  

                  const imageDiv = document.createElement("div");
                  imageDiv.className = "dropdown-list-image mr-3";
                  ...
                  imageDiv.appendChild(statusIndicator);
              ...
              echo '";
                        ...
                        textTruncate.textContent = "' . $row["msg_subject"] . '";

                        const smallText = document.createElement("div");
                        smallText.className = "small text-gray-500";
                        smallText.textContent = "' . $row["created_at"] . '";

                        messageDiv.appendChild(textTruncate);
                        messageDiv.appendChild(smallText);

                        anchor.appendChild(imageDiv);
                        anchor.appendChild(messageDiv);

                        document.getElementById("showMsg").appendChild(anchor);
                      });
              </script>
                ';
            }
            $unreadMsg_Count = COUNT($unread);
          }
          ?>
          ...
          <li class="nav-item dropdown no-arrow mx-1">
            <a class="nav-link dropdown-toggle" id="messagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <?php if (@$unreadMsg_Count > 0) {   ?>
                <span class="badge badge-danger badge-counter"><?php echo $unreadMsg_Count  ?></span> <?php } ?>
            </a>
            ...
            <style>
              .dropdown-content {
                max-height: 300px;
                /* Ensure the content also has a fixed height */
                overflow-y: auto;
          ...
          <div class="modal fade" id="showMessageBox" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="false" data-keyboard="false">
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <form method="POST">
                    <input type="text" value="" id="msg_id" name="msg_id" hidden>
          ...
          <script>
            $('#showMessageBox').on('show.bs.modal', function(event) {
              var button = $(event.relatedTarget); // Button that triggered the modal
              var id = button.data('id'); // Extract info from data-* attributes
              var title = button.data('subject');
