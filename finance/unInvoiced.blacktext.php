...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3 d-flex justify-content-between align-items-center">
      <h6 class="m-0 font-weight-bold text-primary">Un-Invoiced Projects</h6>
      <div class="d-flex">
...
";
            ...
            ?>
              ...
              <tr>
                ...
                <td>
                  <input type="text" name="project_name" value="<?php echo $row['project_name']; ?>" style="border: none; background-color:transparent; color:black; outline: none;" readonly>
                </td>
                <td>
                  <input type="text" name="customer_name" value="<?php echo $row['customer_name']; ?>" style="border: none; background-color:transparent; color:black;  outline: none;" readonly>
                </td>
                ...
                <td class="d-flex justify-content-around">
                  <form id="readyToBeInvoicedForm" method="post">
                    ...
                    <button type="submit" name="readyToBeInvoiced" class="ml-2 btn btn-outline-primary" onclick="return confirm('Are you sure want to set this project to Ready to Invoice status ?');">Ready To Invoice</button>
                  </form>
