...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex align-items-center justify-content-between">
            ...
            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#cleardata">Clear Last Month Data</button>
        ...
        LEFT JOIN csa_finance_payslip AS p ON ei.employee_id = p.employee_id
        LEFT JOIN csa_finance_payslip_records AS pr ON ei.employee_id = pr.employee_id
        WHERE pr.record_date IS NULL OR DATE_FORMAT(pr.record_date, '%Y-%m') != DATE_FORMAT(CURRENT_DATE, '%Y-%m')";
    ...
    function submitForm(action) {
        ...
        document.getElementById('myForm').submit();
                    ...
                    <button type="submit" class="btn btn-primary mt-2 float-right mr-2" onclick="submitForm('bulk_email.php')">Send Mail to Selected Employees</button><br><br>
                    <button type="button" class="btn btn-success mt-2 float-right mr-2" onclick="submitForm('generateExcel.php')">Generate Excel</button>
                </form>
        ...
        <div class="modal-content">
            <div class="form-container mt-2 m-2">
                <form class="progress_data" action="" method="post" enctype="multipart/form-data">
                    ...
                    <input class="form-control" value="0" type="number" name="expenses_data">
