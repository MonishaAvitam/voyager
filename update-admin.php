    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          ...
          <li class="nav-item">
                <a class="nav-link  " id="manage-admin-tab" href="manage-verified-users.php">Manage Verify Users</a>
              </li>
          <li class="nav-item">
          ...
          <div class="row mt-2 text-white">
            <div class="col-md-10 col-md-offset-1">
              <div class="well">
                <h3 class="text-center bg-primary text-white" style="padding: 7px;">Edit Admin</h3><br>
                      ...
                      <div class="row">
                          ...
                          <form class="form-horizontal" role="form" action="" method="post" autocomplete="off">
                            ...
                            <div class="form-group">
                              <div class="col-sm-offset-4 ">
                                <a href="javascript:history.back()" class="btn btn-success-custom">Go Back</a>
                        ...
                        <div class="col-md-5">
                          <a class="btn btn-primary" href="admin-password-change.php?admin_id=<?php echo $row['user_id'];?>">Change Password</a>
