...
if (isset($_GET['project_id'])) {
 ...
 $checker_status = 0;
      ...
      $sql = "UPDATE projects SET assign_to_status = ? , verify_status = ? , project_manager_status = ? ,checker_status = ? , assign_status = ? WHERE project_id = ?";

      // Prepare and execute the statement
      $stmt = $conn->prepare($sql);
      $stmt->bind_param("iissss", $status_value, $verify_status, $project_manager_status, $checker_status, $assign_status, $project_id);
