...
.collapse-item {
  font-weight: bold !important;
  color:rgb(25, 149, 25) !important;
} */
/* Target only the collapse boxes within Projects and Administration */
...
/* Variable setup for colors */
:root {
  --sidebar-bg-color: #2c4770;
}
    ...
    <!-- Nav Item - Pages Collapse Menu -->
      ...
      <li class="nav-item">
        ...
        <a class="nav-link collapsed" href="time-sheet.php">
          ...
          <i class="fa-solid fa-clock" style="color: skyblue"></i>

          <span>Time Booking</span>

        </a>
        <!-- <a class="nav-link collapsed" href=" ./viewQuotations.php">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle " id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <span class="mr-2 d-none d-lg-inline small  " style="color: var(--white);"><?php echo $user_name; ?></span>
              <?php
              ...
              while ($row = $info->fetch(PDO::FETCH_ASSOC)) {
                ...
                if ($user_id !== null) {
                  ...
                  $sql = "SELECT profile_picture FROM tbl_admin WHERE user_id = ?";
